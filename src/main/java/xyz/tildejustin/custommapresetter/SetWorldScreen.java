...
public class SetWorldScreen extends SelectWorldScreen {
    ...
    public void init() {
        ...
        this.addButton(new ButtonWidget(this.width / 2 + (150 / 2) + 5, this.height - 28, 150, 20, I18n.translate("gui.cancel"), (buttonWidget) -> this.minecraft.openScreen(this.parent)));
